...
const greetings = ({name:naam,occup,location,age:umar}) => {
  return (
      <div className="card bg-[#f2f2f2] rounded-3xl overflow-hidden w-80 h-96 transition duration-500 ease-in-out hover:shadow-2xl hover:cursor-pointer ">
        <div className="top bg-[#103091] text-white h-32 flex justify-center items-end relative">
          <img
            src={MyImage}
            alt=""
            className="w-32 h-32 rounded-full absolute -bottom-10 border-4 border-white"
          />
        </div>
        ...
        <div className="mt-2 px-11">
          <p className="text-sm">
            As a Full Stack Developer, I specialize in building web
            applications.
          </p>
        </div>
